...
type ComplexityRoot struct {
	...
	Mutation struct {
		UpdateEnv func(childComplexity int, input model.UpdateEnv) int
	}
...
type MutationResolver interface {
	UpdateEnv(ctx context.Context, input model.UpdateEnv) (*model.Env, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation._update_env":
		...
		return e.complexity.Mutation.UpdateEnv(childComplexity, args["input"].(model.UpdateEnv)), true
...
func (ec *executionContext) field_Mutation__update_env_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 model.UpdateEnv
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNUpdateEnv2gategaurdianᚋserverᚋgraphᚋmodelᚐUpdateEnv(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation__update_env(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateEnv(rctx, fc.Args["input"].(model.UpdateEnv))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNEnv2ᚖgategaurdianᚋserverᚋgraphᚋmodelᚐEnv(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputUpdateEnv(ctx context.Context, obj interface{}) (model.UpdateEnv, error) {
	var it model.UpdateEnv
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"DATABASE_URL", "REDIS_URL"}
	for _, k := range fieldsInOrder {
		...
		case "DATABASE_URL":
			...
			it.DatabaseURL, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		case "REDIS_URL":
			...
			it.RedisURL, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) marshalNEnv2gategaurdianᚋserverᚋgraphᚋmodelᚐEnv(ctx context.Context, sel ast.SelectionSet, v model.Env) graphql.Marshaler {
	return ec._Env(ctx, sel, &v)
}

func (ec *executionContext) marshalNEnv2ᚖgategaurdianᚋserverᚋgraphᚋmodelᚐEnv(ctx context.Context, sel ast.SelectionSet, v *model.Env) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNUpdateEnv2gategaurdianᚋserverᚋgraphᚋmodelᚐUpdateEnv(ctx context.Context, v interface{}) (model.UpdateEnv, error) {
	res, err := ec.unmarshalInputUpdateEnv(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}
